...
namespace Maersk.Sorting.Api
{
    public class SortJobProcessor : ISortJobProcessor
    {
        ...
        public SortJobProcessor(ILogger<SortJobProcessor> logger , JobStore jobStore)
        {
            _logger = logger;
            _jobStore = jobStore;
        }
        ...
        public SortJob[] GetJobs() =>_jobStore.GetJobs();

        public SortJob GetJob(string jobId) => _jobStore.GetJob(jobId);
